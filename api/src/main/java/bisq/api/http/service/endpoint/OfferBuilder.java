...
import bisq.api.http.facade.MarketFacade;
...
public class OfferBuilder {
    ...
    public OfferBuilder(AccountAgeWitnessService accountAgeWitnessService,
                        ...
                        MarketFacade marketFacade, P2PService p2PService,
                        Preferences preferences,
                        PriceFeedService priceFeedService,
                        User user, TxFeeEstimationService txFeeEstimationService) {
    ...
    public Offer build(String accountId,
        ...
        Tuple2<Coin, Integer> estimatedFeeAndTxSize = txFeeEstimationService.getEstimatedFeeAndTxSizeForMaker(fundsNeededForMaker, makerFee);
    ...
    private void validateMarketPair(String marketPair) {
        if (StringUtils.isEmpty(marketPair)) {
            ...
            boolean existingPair = MarketFacade.getMarketList().stream()
