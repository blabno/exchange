...
import bisq.api.http.facade.ArbitratorFacade;
import bisq.api.http.model.Arbitrator;
...
public class ArbitratorEndpoint {
    ...
    @Consumes(MediaType.APPLICATION_JSON)
    @POST
    public void register(@Suspended AsyncResponse asyncResponse, @Valid @NotNull RegisterArbitratorRequest data) {
        UserThread.execute(() -> {
            try {
